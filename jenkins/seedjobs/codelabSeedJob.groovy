...
createDockerBuildJob("codelab-config-service", ".", "codelab-config-service", registryUrl, registryUser, registryPass)
...
createDockerBuildJob("codelab-registry-service", ".", "codelab-registry-service", registryUrl, registryUser, registryPass)
...
createDockerBuildJob("codelab-gateway-service", ".", "codelab-gateway-service", registryUrl, registryUser, registryPass)
...
createDockerBuildJob("codelab-monitoring-service", ".", "codelab-monitoring-service", registryUrl, registryUser, registryPass)
...
createDockerBuildWithDbJob("codelab-auth-service", ".", "codelab-auth-service", "codelab-auth-mongodb", registryUrl, registryUser, registryPass)
...
createDockerBuildWithDbJob("codelab-account-service", ".", "codelab-account-service", "codelab-account-mongodb", registryUrl, registryUser, registryPass)
...
createDockerBuildWithDbJob("codelab-article-service", ".", "codelab-article-service", "codelab-article-mongodb", registryUrl, registryUser, registryPass)
